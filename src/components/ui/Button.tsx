...
import { Stranger } from '@/types'; // Opsional jika tipe diatur khusus
...
export const Button: React.FC<ButtonProps> = ({ children, variant = 'primary', className, ...props }) => {
  return (
    <button
      className={clsx(
        "px-4 py-2.5 rounded-xl text-xs font-bold transition-all duration-200 active:scale-98 disabled:opacity-50 disabled:pointer-events-none",
